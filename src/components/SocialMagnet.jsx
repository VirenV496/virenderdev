...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/virender-vishwakarma/', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/VirenV496', icon: ICONS.GitHub },
  { name: 'X', url: '', icon: ICONS.Twitter },
  { name: 'Mail', url: 'mailto:virenderv329@gmail.com', icon: ICONS.Mail },
];
